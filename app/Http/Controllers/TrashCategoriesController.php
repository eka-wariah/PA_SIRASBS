...
class TrashCategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('wastebank_officer.trash_category.index', compact(['trash_categories']));
    }
    ...
    public function edit(trash_categories $trash_categories, $id)
    {
        ...
        return view('wastebank_officer.trash_category.edit',compact(['editTrashCategories']));
    }
