...
class WasteBanksController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('wastebank_officer.waste_bank.index', compact(['waste_banks', 'users', 'trash_categories']));
    }
    ...
    public function create()
    {
        $trash_categories = trash_categories::all();
        $users = User::all();
        return view('wastebank_officer.waste_bank.create', compact('trash_categories', 'users'));
    }
    ...
    public function edit(waste_banks $waste_banks, $id)
    {
        ...
        $trash_categories = trash_categories::all();
        $users = User::all();       
        return view('wastebank_officer.waste_bank.edit',compact(['editWasteBanks', 'trash_categories', 'users']));
    }
