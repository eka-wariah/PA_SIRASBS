                    ...
                    <table id="file_export" class="table w-100 table-striped table-bordered display text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                     <a href="/treasurer/payment_category/{{ $payment_categories->pyc_id}}/edit" class="btn btn-primary">Edit</a>
                                     <a href="/treasurer/payment_category/{{ $payment_categories->pyc_id}}/destroy" class="btn btn-danger" data-confirm-delete="true">Delete</a>
